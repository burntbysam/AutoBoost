# AutoBoost Architecture (Beta 0.7.2)
...
```
autoboost/
  __init__.py            app name + version (AutoBoost Beta 0.7.2)
...
Beta 0.7.2 -- two validated tools plus a combined runner that chains them:
